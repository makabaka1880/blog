...
::DefBox{id="First Wave Feminism"}
The **First-Wave Feminism** is the term for the origins of the movement in the early 20<sup>th</sup> century, a time when, in USA, Feminism was strongly associated with the *avocation for women's suffrage*.
::
...
The opening paragraph give us a lot of information about the setting. Martha, the <mark>character</mark>, was just an ordinary housewife. The storm-door is a heavy door (like a firedoor) to block storms, and north wind gushed in. The <mark>time</mark> of the setting was given here: wintertime. 

Martha made a "scandalized" sweep of the kitchen. This action, with the later on imagery (bread all ready for mixing, no shape for leaving), asks the question: why is the kitchen so untidy. This brings up tension and creates suspense. BTW this also gives us the <mark>location</mark> of the setting: in a rural village.

::QuoteBox{source="P2 - 4"}
...
The sheriff is involved. There must have been a crime, or an ongoing investigation. What happened? This creates suspense, but also pertially gives the <mark>what</mark> of the setting. 

::QuoteBox{source="P5 - 4"}
...
Other characters were introduced. Mrs. Peters, sheriff's wife, gave Martha the first impression of "not being like a sheriff's wife". The stereotype for sheriff's wife is begin tough and strong. Therefore, Mrs. Peters was "small and thin". On the other hand, the sheriff was a masculine character: a "heavy" man with big, stinging voice. He will be stern and serious when in public, especially in investigation. 
...
Mrs. Peters is a timid women.

::DefBox{id="Ventured"}
**Venture**. *Transitive (v.)* offer, remark, to make bold
- May or might I venture a suggestion?
- to venture to suggest that ...
::

She might have felt awkwardness so she "ventured" to break the ice.
...
The Wright place is depicted as "lonesome", "hollow". Similarly, the inhabitants could be infered to be "lonesome" and "hollow" too. 
...
Martha definitely knew what happened. It should have been something very horrifying or awful, since up to now the narrations held that back to create suspense. Minnie Foster's status as a married women and her appearence under the historical context also supports this conjecture.

::QuoteBox{source="P10 - 12"}
...
::DefBox{id="Attorney"}
**Attorney** *(N.)* legal delegate of an entity.
::

Here Attorney must likely meant the county inspector; the one in charge of pressing charges against suspects by the name of the county.

The two womens are timid, symbolizing the low societal status of women.

::QuoteBox{source="P11 - 18"}
...
Now that it is clear that a crime has been commited. The sheriff is protecting the crime scene, so it seems like its quite a big crime. From the dialog, it seems like that the sheriff didn't like his job very much. On the plot, someone was at the crime scene yesterday because sheriffs were overloaded and noone could guard the scene. The sheriff neglected his duty.
