...
const glyphToSvg = {
    ...
    // Only move
    '□': composeGlyph('#43a040', '<path stroke="#fff" stroke-width="7" fill="none" d="M30,30 H70 V70 H30 z"/>'),
...
export const glyphToSvgMap = new Map<string, (stackedNumber: number) => string>([
    ...
    ["mistake", glyphToSvg["?"]],
    ["blunder", glyphToSvg["??"]],
    ["interesting", glyphToSvg["!?"]],
    ["good", glyphToSvg["!"]],
    ["brilliant", glyphToSvg["!!"]],
    ["correct", glyphToSvg["✓"]],
    ["incorrect", glyphToSvg["✗"]],

    // Repetitions
    ["repetition1", glyphToSvg["①"]],
    ["repetition2", glyphToSvg["②"]],
    ["repetition3", glyphToSvg["③"]],
    ["repetition4", glyphToSvg["④"]],
    ["repetition5", glyphToSvg["⑤"]],
    ...
    ["equal", glyphToSvg["="]],
    ["unclear", glyphToSvg["∞"]],
    ["withCompensation", glyphToSvg["=∞"]],
    ["withIdea", glyphToSvg["∆"]],

    // Numerical Advantage
    ["whiteSlightlyBetter", glyphToSvg["⩲"]],
    ["blackSlightlyBetter", glyphToSvg["⩱"]],
